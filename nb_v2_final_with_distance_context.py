...
- encoder diagnostics
- final WAPE summary
- distance-to-holiday future context features
"""
...
def load_real_data(data_raw):
    ...
    context_cols = ["our_price", "in_stock_dph"] + holiday_cols + distance_cols
    ...
    # Distance-to-holiday features are future-known calendar features.
    # Keep direction if the raw value has sign: negative = before, positive = after.
    ...
    print(f"Holiday indicator cols: {len(holiday_cols)}")
    print(f"Distance cols: {len(distance_cols)}")
